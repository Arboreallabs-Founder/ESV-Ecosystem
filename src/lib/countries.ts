// ISO 3166-1 country list (sovereign states + commonly-referenced territories) for the
// Country autocomplete used on Investor/Company forms. Flags render via the `flag-icons`
// package (real SVG images, keyed by lowercase ISO code) — Unicode flag emoji don't
// render as flags on Windows (no flag glyphs in the system font), so we don't use those.
...
export const COUNTRIES: CountryEntry[] = [
  ...
  { code: 'CW', name: 'Curacao' }, { code: 'CY', name: 'Cyprus' }, { code: 'CZ', name: 'Czech Republic' },
  ...
  { code: 'VA', name: 'Holy See (Vatican)' }, { code: 'HN', name: 'Honduras' }, { code: 'HK', name: 'Hong Kong' },
  ...
  { code: 'MO', name: 'Macau' }, { code: 'MG', name: 'Madagascar' }, { code: 'MW', name: 'Malawi' },
  ...
  { code: 'RU', name: 'Russia' }, { code: 'RW', name: 'Rwanda' }, { code: 'BL', name: 'Saint Barthelemy' },
  ...
  { code: 'VN', name: 'Vietnam' }, { code: 'VI', name: 'Virgin Islands (US)' }, { code: 'WF', name: 'Wallis and Futuna' },
